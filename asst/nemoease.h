...
static inline int nemoease_set(struct nemoease *ease, uint32_t type)
{
...
static inline int nemoease_set_cubic(struct nemoease *ease, double sx, double sy, double ex, double ey)
{
	ease->sx = sx;
	ease->sy = sy;
	ease->ex = ex;
